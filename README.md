...
> ***Disclaimer:*** *The CCGS:TE repo remains a fork of CCGS and maintains only the extension works.The existing game development aspects of the framework are maintained in the CCGS base repo.*
...
* The `/diagnose`, `/code-recon`, and `/entropy-scan` skills are adapted from **skills** by **mattpocock**, licensed under MIT.
